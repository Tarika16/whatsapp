...
const styles: Record<string, React.CSSProperties> = {
    ...
    myMessage: { alignSelf: 'flex-end', backgroundColor: '#005c4b', padding: '8px 10px', borderRadius: '8px', maxWidth: '75%', boxShadow: '0 1px 2px rgba(0,0,0,0.3)', display: 'flex', flexDirection: 'column', color: '#ffffff' },
    theirMessage: { alignSelf: 'flex-start', backgroundColor: '#202c33', padding: '8px 10px', borderRadius: '8px', maxWidth: '75%', boxShadow: '0 1px 2px rgba(0,0,0,0.3)', display: 'flex', flexDirection: 'column', color: '#ffffff' },
    msgContent: { fontSize: '15px', color: '#e9edef', lineHeight: '20px', fontWeight: '400' },
    msgTime: { fontSize: '11px', color: '#aebac1', alignSelf: 'flex-end', marginTop: '4px' },
    lastMsg: { fontSize: '13px', color: '#8696a0', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
